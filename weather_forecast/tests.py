...
class TestModel(TestCase):
    ...
    def test_get_forecast_from_api_with_current_date(self):
        ...
        result = models.Forecast.near_forecast.get_forecast(city_name, date)
    ...
    def test_forecasts_for_different_citys(self):
        ...
        second_city = 'Tokyo'
        date = datetime.datetime.today().date()
        first_result = models.Forecast.near_forecast.get_forecast(first_city, date)
        second_result = models.Forecast.near_forecast.get_forecast(second_city, date)
