...
class ForecastPage(View):
    ...
    def get(self, request):
        ...
        context = Forecast.next_five_days.get_forecast(self.initial['city'], self.initial['date'])
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            context = Forecast.next_five_days.get_forecast(cleaned_data['city'], cleaned_data['date'])
        ...
        if not context['forecast_list']:
            ...
            context.update(Forecast.next_five_days.get_forecast(self.initial['city'], self.initial['date']))
            context['dates'] = get_dates_for_view(datetime.today())
        context['form'] = form
